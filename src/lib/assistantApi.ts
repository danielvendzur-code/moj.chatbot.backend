...
export function localAssistantReply(question: string): string {
  ...
  if (/cen|koľko|rozpočet|stojí|suma/.test(normalized)) {
    return "Na webe je chatbot alebo poradca od 347 €, kalkulačka alebo konfigurátor od 447 € a technická prevádzka od 10 € mesačne. Konečná cena závisí od rozsahu a napojení; vo „Vyskladať riešenie“ označte, čo potrebujete, a konkrétna ponuka uvedie aj DPH a celkovú cenu.";
  }
