...
const SYSTEM_PROMPT = [
  ...
  "• Koverta (koverta.sk): 3D konfigurátor prístreškov pre autá, záhradných prístreškov, bioklimatických pergol, carportov a prestrešení Soltec. Zákazník vyberie typ, umiestnenie (samostatne, pri stene, v rohu), rozmer, farbu, strechu a výplne, vidí model v 3D aj s autom alebo posedením a orientačnú cenu, a potom odošle dopyt so zostavou. Ukážka a popis sú na mojchatbot.sk/3d-konfigurator.",
  "• DERAT (derat.sk): kalkulačka a dopytový asistent pre deratizáciu, dezinsekciu a dezinfekciu — návštevník vyberie problém a rozsah, dostane orientačný výsledok a odošle dopyt. Prípadová štúdia je na mojchatbot.sk/projekty/derat.",
